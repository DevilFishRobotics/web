  ...
  return (
    <>
      <div className="flex space-x-4 justify-center">
        <Link href="https://www.instagram.com/DevilfishRobotics/">
          <div
        ...
        <Link href="https://twitter.com/DevilfishRobots">
          <div
        ...
        <Link href="https://linkedin.com/company/devilfishrobotics/">
          <div
        ...
        <Link href="https://github.com/DevilFishRobotics">
          <div
          ...
          >
            <svg
              ...
              viewBox="0 0 32 32"
              data-v-77f39053=""
              className="h-12 w-12 text-[#171515]"
            >
              <path
